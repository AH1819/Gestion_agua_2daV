...
import Modelo.Logeo;
import Conexion.PersistenciaLoginBD;
...
public class ConfigurarBD extends javax.swing.JFrame {
    ...
    Logeo lg;
    ErrorsAndSuccessesBD eas;
    ConexionBD cn;
    PersistenciaLogeoBD pgs;
    ...
    private void initComponents() {
        ...
        setAlwaysOnTop(true);
        setMinimumSize(new java.awt.Dimension(528, 494));
        ...
        password_view.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Recursos/mostrar.png"))); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(Host_BD, javax.swing.GroupLayout.PREFERRED_SIZE, 420, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(BD_name, javax.swing.GroupLayout.PREFERRED_SIZE, 420, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(password_view, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(Test_con, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addComponent(ErrorMessage, javax.swing.GroupLayout.DEFAULT_SIZE, 105, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void Test_conActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Test_conActionPerformed
        if (!User.getText().isEmpty() && !User.getText().equals("Campo vacio")) {
            if (!String.valueOf(Password.getPassword()).isEmpty() && !String.valueOf(Password.getPassword()).equals("Campo vacio")) {
                if (!Host_BD.getText().isEmpty() && !Host_BD.getText().equals("Campo vacio")) {
                    if (!BD_name.getText().isEmpty() && !BD_name.getText().equals("Campo vacio")) {
                        if (!Port.getText().isEmpty() && !Port.getText().equals("Campo vacio")) {
                            new Thread() {
                                public void run() {
                                    Test_con.setEnabled(false);
                                    TestearConexion();
                                    Test_con.setEnabled(true);
                                }
                            }.start();
                        } else {
    ...
    private void password_viewMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_password_viewMouseClicked
        ...
        if (status) {
            password_view.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Recursos/ocultar.png")));
            Password.setEchoChar((char) 0);
        } else {
            password_view.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Recursos/mostrar.png")));
    ...
    private void GuardarConexion() {
        PersistenciaLoginBD p = new PersistenciaLoginBD(Host_BD.getText(), BD_name.getText(), Port.getText());
        pgs = new PersistenciaLogeoBD();
        if (pgs.Guardar(p)) {
